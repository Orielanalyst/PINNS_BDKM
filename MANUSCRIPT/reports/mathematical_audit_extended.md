# Mathematical audit of the 49-branch catalogue (extended ansatz)
...
Of the 49 audited pairs, **9 pairs yield at least one verified, nontrivial solution family** (17 families total); 40 pairs are rejected.

### Accepted families

| branch | (n,m) | tier | group | free params | constraints | max|F| | rel RMS |
|---|---|---|---|---|---|---|---|
| nneg1_mneg1_f0 | (-1,-1) | B | stress | lambda2, asq, beta2, omega | c=0; ell=0; alpha2=0; Gamma=0; beta4=0; beta3=0; lambda1=beta2*lambda2*omega; gamma=-beta2*lambda2**2/asq; kappa=beta2*(2*lambda2**2 + omega**2)/2 | 1.1e-50 | 1.5e-51 |
| nneg1_mneg1_f3 | (-1,-1) | B | stress | lambda2, asq, beta2, c | omega=0; lambda1=0; beta3=0; ell=-c*lambda2**2; Gamma=0; beta4=0; kappa=beta2*lambda2**2; gamma=-beta2*lambda2**2/asq; alpha2=-2*c*lambda2**2/asq | 2.4e-50 | 2.7e-51 |
| nneg1_m0_f0 | (-1,0) | B | stress | lambda2, asq, beta2, beta3, beta4, Gamma, omega | c=0; ell=0; alpha2=0; lambda1=lambda2*(6*beta2*omega - beta3*lambda2**2 + 3*beta3*omega**2 + beta4*lambda2**2*omega - beta4*omega**3)/6; kappa=-beta2*lambda2**2/2 + beta2*omega**2/2 - beta3*lambda2**2*omega/2 + beta3*omega**3/6 - beta4*lambda2**4/24 + beta4*lambda2**2*omega**2/4 - beta4*omega**4/24; gamma=0 | 1.8e-50 | 4.8e-52 |
| nneg1_m0_f2 | (-1,0) | B | stress | lambda2, asq, beta2, beta3, beta4, c, Gamma | omega=0; lambda1=-beta3*lambda2**3/6; ell=c*lambda2**2/2; alpha2=0; kappa=lambda2**2*(-12*beta2 - beta4*lambda2**2)/24; gamma=0 | 2.4e-50 | 5.5e-52 |
| nneg1_m1_f0 | (-1,1) | B | stress | lambda2, asq, beta2, beta3, beta4, Gamma, omega | c=0; ell=0; alpha2=0; lambda1=lambda2*(6*beta2*omega - 4*beta3*lambda2**2 + 3*beta3*omega**2 + 4*beta4*lambda2**2*omega - beta4*omega**3)/6; kappa=-2*beta2*lambda2**2 + beta2*omega**2/2 - 2*beta3*lambda2**2*omega + beta3*omega**3/6 - 2*beta4*lambda2**4/3 + beta4*lambda2**2*omega**2 - beta4*omega**4/24; gamma=0 | 4.5e-48 | 3.7e-51 |
| nneg1_m1_f2 | (-1,1) | B | stress | lambda2, asq, beta2, beta3, beta4, c, Gamma | omega=0; lambda1=-2*beta3*lambda2**3/3; ell=2*c*lambda2**2; alpha2=0; kappa=2*lambda2**2*(-3*beta2 - beta4*lambda2**2)/3; gamma=0 | 4.2e-48 | 3.1e-51 |
| n0_mneg1_f0 | (0,-1) | B | stress | lambda2, asq, beta2, omega | Gamma=0; c=0; alpha2=0; ell=0; beta4=0; beta3=0; lambda1=beta2*lambda2*omega; gamma=-beta2*lambda2**2/asq; kappa=beta2*(-lambda2**2 + omega**2)/2 | 1.3e-50 | 2.3e-51 |
| n0_mneg1_f1 | (0,-1) | B | stress | lambda2, asq, beta2, c | Gamma=0; omega=0; beta4=0; beta3=0; lambda1=0; gamma=-beta2*lambda2**2/asq; kappa=-beta2*lambda2**2/2; alpha2=-2*c*lambda2**2/asq; ell=c*lambda2**2/2 | 1.2e-50 | 2.6e-51 |
| n0_m0_f0 | (0,0) | A | main | lambda1, lambda2, asq, beta2, beta3, beta4, c, gamma, alpha2, Gamma, omega | ell=(-Gamma*asq*c*omega**2 + alpha2*asq - c*omega**2)/(2*(Gamma*asq + 1)); kappa=(12*Gamma*asq*beta2*omega**2 + 4*Gamma*asq*beta3*omega**3 - Gamma*asq*beta4*omega**4 - 24*asq*gamma + 12*beta2*omega**2 + 4*beta3*omega**3 - beta4*omega**4)/(24*(Gamma*asq + 1)) | 2.6e-51 | 1.2e-51 |
| n0_m1_f0 | (0,1) | B | stress | lambda2, asq, beta2, beta3, beta4, Gamma, omega | c=0; ell=0; alpha2=0; lambda1=lambda2*(6*beta2*omega - beta3*lambda2**2 + 3*beta3*omega**2 + beta4*lambda2**2*omega - beta4*omega**3)/6; kappa=-beta2*lambda2**2/2 + beta2*omega**2/2 - beta3*lambda2**2*omega/2 + beta3*omega**3/6 - beta4*lambda2**4/24 + beta4*lambda2**2*omega**2/4 - beta4*omega**4/24; gamma=0 | 1.9e-50 | 4.6e-52 |
| n0_m1_f2 | (0,1) | B | stress | lambda2, asq, beta2, beta3, beta4, c, Gamma | omega=0; ell=c*lambda2**2/2; alpha2=0; lambda1=-beta3*lambda2**3/6; kappa=lambda2**2*(-12*beta2 - beta4*lambda2**2)/24; gamma=0 | 2.3e-50 | 5.2e-52 |
| n1_mneg1_f0 | (1,-1) | B | stress | lambda2, asq, beta2, omega | Gamma=0; beta4=0; c=0; alpha2=0; ell=0; beta3=0; lambda1=beta2*lambda2*omega; gamma=-beta2*lambda2**2/asq; kappa=beta2*(-4*lambda2**2 + omega**2)/2 | 1.5e-50 | 3.4e-51 |
| n1_mneg1_f1 | (1,-1) | B | stress | lambda2, asq, beta2, c | Gamma=0; beta4=0; omega=0; beta3=0; lambda1=0; ell=2*c*lambda2**2; kappa=-2*beta2*lambda2**2; gamma=-beta2*lambda2**2/asq; alpha2=-2*c*lambda2**2/asq | 5.0e-50 | 8.8e-51 |
| n1_m0_f0 | (1,0) | B | main | lambda2, asq, beta2, omega | Gamma=0; beta4=0; c=0; alpha2=0; ell=0; beta3=0; lambda1=beta2*lambda2*omega; gamma=beta2*lambda2**2/asq; kappa=beta2*(-lambda2**2 + omega**2)/2 | 6.7e-52 | 2.9e-52 |
| n1_m0_f1 | (1,0) | B | main | lambda2, asq, beta2, c | Gamma=0; beta4=0; omega=0; beta3=0; lambda1=0; gamma=beta2*lambda2**2/asq; kappa=-beta2*lambda2**2/2; alpha2=2*c*lambda2**2/asq; ell=c*lambda2**2/2 | 1.4e-51 | 6.8e-52 |
| n1_m1_f0 | (1,1) | B | main | lambda2, asq, beta2, omega | c=0; ell=0; alpha2=0; Gamma=0; beta4=0; beta3=0; lambda1=beta2*lambda2*omega; gamma=-beta2*lambda2**2/asq; kappa=beta2*(2*lambda2**2 + omega**2)/2 | 1.1e-51 | 3.9e-52 |
| n1_m1_f3 | (1,1) | B | main | lambda2, asq, beta2, c | omega=0; ell=-c*lambda2**2; lambda1=0; beta3=0; Gamma=0; beta4=0; kappa=beta2*lambda2**2; gamma=-beta2*lambda2**2/asq; alpha2=-2*c*lambda2**2/asq | 2.1e-51 | 6.9e-52 |
...
- Tier A (full model: 4th-order dispersion + saturation + gain/loss all active): **1**
- Tier B (nontrivial reduced model): **16**
